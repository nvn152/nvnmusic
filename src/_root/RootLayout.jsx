    ...
    <div className="relative flex">
      ...
      <div className="flex-1 flex flex-col custom-gradient">
        ...
        <div className="px-6 h-[calc(100vh-60px)] overflow-y-scroll hide-scrollbar flex xl:flex-row flex-col-reverse">
          ...
          <div className="xl:sticky relative top-0 max-w-md h-fit">
            <TopPlay />
          </div>
        </div>
      </div>
      {activeSong?.name && (
        <div className="absolute h-24 bottom-0 left-0 right-0 flex animate-slideup bg-gradient-to-br from-white/10 to-black backdrop-blur-lg rounded-t-3xl z-10">
          <MusicPlayer />
        </div>
      )}
    </div>
